...
if (isset($_POST['submit'])) {
    ...
    if ($harga_jual <= $harga_beli) {
        ...
        if ($file_gambar['error'] == 0) {
            ...
            $destination = $_SERVER['DOCUMENT_ROOT'] . '/lab12_php_oop/assets/gambar/' . $filename;
        ...
        if (empty($error)) {
            ...
            if ($result !== false) {
                ...
                echo '<script>
                    setTimeout(function() {
                        window.location.href = "/lab12_php_oop/barang?success=tambah";
                    }, 2000);
                </script>';
            } else {
...
<div class="main-content">
    ...
    <div class="card">
        ...
        <div class="card-header">
            ...
            <a href="/lab12_php_oop/user/index" class="btn btn-warning">
