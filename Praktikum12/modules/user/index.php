...
if (!isset($_SESSION['user'])) {
    header('Location: /lab12_php_oop/modules/auth/login');
    exit;
}
...
// base url
$base_url = 'http://' . $_SERVER['HTTP_HOST'] . '/lab12_php_oop/';
    ...
    <div class="card">
        ...
        <div class="card-header">
            ...
            <?php if ($_SESSION['user']['role'] == 'admin'): ?>
                <a href="/lab12_php_oop/user/tambah" class="btn btn-primary">
            ...
            <table class="data-table">
                ...
                <?php if (!empty($barangList)) : ?>
                    <?php foreach ($barangList as $row) : ?>
                        ...
                        <?php
                        $gambar = $row->gambar;
                        $path_gambar = $_SERVER['DOCUMENT_ROOT'] . '/lab12_php_oop/assets/gambar/' . $gambar;
                        ...
                        <tr>
                            ...
                            <td class="action-buttons">
                                <a href="/lab12_php_oop/user/edit?id=<?= $row->id_barang; ?>" 
                                   class="btn-action btn-edit" title="Edit">
                                    <i class="fas fa-edit"></i>
                                </a>
                                <a href="/lab12_php_oop/user/delete?id=<?= $row->id_barang; ?>"
                    ...
                    <tr>
                        <td colspan="<?= $_SESSION['user']['role'] == 'admin' ? '7' : '6' ?>" style="text-align:center; padding: 20px;">
                            <div class="empty-state">
                                ...
                                <?php if ($_SESSION['user']['role'] == 'admin'): ?>
                                    <a href="/lab12_php_oop/barang/tambah" class="btn btn-primary">
